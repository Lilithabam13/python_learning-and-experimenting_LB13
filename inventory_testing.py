...
# Ideal way to ensure validation and contiounsly prompt user for valid inputs when using a 

# while True:
#     try:
#         user_menu_choice = int(input("Please select an option from the menu: "))
#         if 1 <= user_menu_choice <= 7:
#             break
#         else:
#             print("Please select a valid option from 1 to 7")
#     except ValueError:
